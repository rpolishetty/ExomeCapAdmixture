'''
ExomeCapAdmixture for Latino American populations
'''
import sys
...
os.system("vcftools --vcf /Users/Raw_HCC/HCC_normal.vcf –max-missing 0.9 –recode –out /Users/HCC_pruned/HCC_normal_pruned.vcf")
os.system("vcftools --vcf /Users/HCC_pruned/HCC_normal_pruned.vcf --min-alleles 2 --max-alleles 2 --recode --out /Users/HCC_pruned/HCC_normal_pruned2.vcf")
os.system("vcftools --vcf /Users/1000GData/1000G.vcf –keep /Users/Raw_HCC/ancestral_population_codes.txt –recode –out /Users/Required1000G/1000G_filtered_population.vcf")
os.system("vcftools --vcf /Users/HCC_pruned/HCC_normal_pruned2.vcf --positions /Users/Raw_HCC/ancestral_population_codes.txt --recode --out /Users/HCC_pruned/HCC_populationcodes_filter.vcf")
os.system("vcftools --vcf /Users/HCC_pruned/HCC_populationcodes_filter.vcf  --plink --out /Users/HCC_pruned/HCC_plink_filter.vcf")
os.system("plink --file /Users/HCC_pruned/HCC_plink_filter.ped --maf 0.01")
os.system("bgzip /Users/HCC_pruned/myfile.vcf")
os.system("tabix -p vcf /Users/HCC_pruned/myfile.vcf.gz")
os.system("vcf-merge myfile.vcf.gz HCC_pruned.vcf.gz HCC_normal_pruned2.vcf.gz | bgzip -c > Final_AIM.vcf.gz")
os.system("plink --file /Users/HCC_pruned/HCC_plink_filter.ped --r2")
os.system("plink --vcf /Users/HCC_pruned/HCC_normal_AIM.vcf --out AIM_HCC.bed")
'''
Now we have all the files necessary to use the python script proposed by Galanter et. al to 
LD prune our SNPs and select AIMs based on In Statistic.  
Move the individual ancestral .freq files to the AIM selection algorithm folder after download. 
Create a text file called “aims_properties.txt” and format the following requirements and propertie
'''
#os.system("plink --vcf /Users/HCC_pruned/HCC_normal_AIM.vcf --out AIM_HCC.bed")
#os.system("plink --vcf /Users/HCC_pruned/HCC_normal_AIM.vcf --out AIM_HCC.bed")
#os.system("plink --vcf /Users/HCC_pruned/HCC_normal_AIM.vcf --out AIM_HCC.bed")
...
os.system("cd /Users/AIMGeneration")
